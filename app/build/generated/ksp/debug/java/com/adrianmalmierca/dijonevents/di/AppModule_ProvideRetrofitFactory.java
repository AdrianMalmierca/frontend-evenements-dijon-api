...
public final class AppModule_ProvideRetrofitFactory implements Factory<Retrofit> {
  ...
  public static AppModule_ProvideRetrofitFactory create(Provider<OkHttpClient> okHttpClientProvider,
      Provider<Moshi> moshiProvider) {
    return new AppModule_ProvideRetrofitFactory(okHttpClientProvider, moshiProvider);
  }

  public static Retrofit provideRetrofit(OkHttpClient okHttpClient, Moshi moshi) {
    return Preconditions.checkNotNullFromProvides(AppModule.INSTANCE.provideRetrofit(okHttpClient, moshi));
  }
}
